...
static const _DoubleTwoInts_type_support_symbol_names_t _DoubleTwoInts_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_messages, msg, DoubleTwoInts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_messages, msg, DoubleTwoInts)),
  }
};
...
{
  return &::my_messages::msg::rosidl_typesupport_cpp::DoubleTwoInts_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_messages, msg, DoubleTwoInts)() {
  return get_message_type_support_handle<my_messages::msg::DoubleTwoInts>();
}
