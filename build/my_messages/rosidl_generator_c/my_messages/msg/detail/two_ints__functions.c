...
my_messages__msg__TwoInts__create()
{
  ...
  my_messages__msg__TwoInts * msg = (my_messages__msg__TwoInts *)allocator.allocate(sizeof(my_messages__msg__TwoInts), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_messages__msg__TwoInts));
  bool success = my_messages__msg__TwoInts__init(msg);
  if (!success) {
...
my_messages__msg__TwoInts__destroy(my_messages__msg__TwoInts * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_messages__msg__TwoInts__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_messages__msg__TwoInts__Sequence__init(my_messages__msg__TwoInts__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_messages__msg__TwoInts * data = NULL;

  if (size) {
    data = (my_messages__msg__TwoInts *)allocator.zero_allocate(size, sizeof(my_messages__msg__TwoInts), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_messages__msg__TwoInts__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_messages__msg__TwoInts__fini(&data[i - 1]);
      }
...
my_messages__msg__TwoInts__Sequence__fini(my_messages__msg__TwoInts__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_messages__msg__TwoInts__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_messages__msg__TwoInts__Sequence * array = (my_messages__msg__TwoInts__Sequence *)allocator.allocate(sizeof(my_messages__msg__TwoInts__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_messages__msg__TwoInts__Sequence__init(array, size);
  if (!success) {
...
my_messages__msg__TwoInts__Sequence__destroy(my_messages__msg__TwoInts__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_messages__msg__TwoInts__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_messages__msg__TwoInts__Sequence__are_equal(const my_messages__msg__TwoInts__Sequence * lhs, const my_messages__msg__TwoInts__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_messages__msg__TwoInts__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_messages__msg__TwoInts__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_messages__msg__TwoInts);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_messages__msg__TwoInts * data =
      (my_messages__msg__TwoInts *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_messages__msg__TwoInts__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_messages__msg__TwoInts__fini(&output->data[i]);
        }
        return false;
      }
    }
