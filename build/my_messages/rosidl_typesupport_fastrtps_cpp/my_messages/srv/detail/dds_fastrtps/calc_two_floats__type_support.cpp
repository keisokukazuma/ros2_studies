...
#include "my_messages/srv/detail/calc_two_floats__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const my_messages::srv::CalcTwoFloats_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_messages::srv::CalcTwoFloats_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CalcTwoFloats_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_messages::srv::CalcTwoFloats_Request *>(
...
static size_t _CalcTwoFloats_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CalcTwoFloats_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CalcTwoFloats_Request__callbacks = {
  "my_messages::srv",
...
static rosidl_message_type_support_t _CalcTwoFloats_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CalcTwoFloats_Request__callbacks,
...
{
  return &my_messages::srv::typesupport_fastrtps_cpp::_CalcTwoFloats_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const my_messages::srv::CalcTwoFloats_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_messages::srv::CalcTwoFloats_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CalcTwoFloats_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_messages::srv::CalcTwoFloats_Response *>(
...
static size_t _CalcTwoFloats_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CalcTwoFloats_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CalcTwoFloats_Response__callbacks = {
  "my_messages::srv",
...
static rosidl_message_type_support_t _CalcTwoFloats_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CalcTwoFloats_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &my_messages::srv::typesupport_fastrtps_cpp::_CalcTwoFloats_Response__handle;
}
...
static service_type_support_callbacks_t _CalcTwoFloats__callbacks = {
  "my_messages::srv",
  "CalcTwoFloats",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_messages, srv, CalcTwoFloats_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_messages, srv, CalcTwoFloats_Response)(),
...
static rosidl_service_type_support_t _CalcTwoFloats__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CalcTwoFloats__callbacks,
...
{
  return &my_messages::srv::typesupport_fastrtps_cpp::_CalcTwoFloats__handle;
}
