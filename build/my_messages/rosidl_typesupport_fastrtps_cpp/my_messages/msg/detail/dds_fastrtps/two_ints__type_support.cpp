...
#include "my_messages/msg/detail/two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const my_messages::msg::TwoInts *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_messages::msg::TwoInts *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TwoInts__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_messages::msg::TwoInts *>(
...
static size_t _TwoInts__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TwoInts(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TwoInts__callbacks = {
  "my_messages::msg",
  "TwoInts",
...
static rosidl_message_type_support_t _TwoInts__handle = {
...
{
  return &my_messages::msg::typesupport_fastrtps_cpp::_TwoInts__handle;
}
